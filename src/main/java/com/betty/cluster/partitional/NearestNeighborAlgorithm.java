package com.betty.cluster.partitional;

import java.util.ArrayList;
import java.util.List;

import com.betty.model.Cluster;
...
import com.betty.utils.ObjectToIndexMapping;
    ...
    private void calculateDistanceMatrix() {
        ...
        for(int i = 0, n = allDataPoints.length; i < n; i++) {
            ...
            for(int j = i + 1; j < n; j++) {
                ...
                a[i][j] = dist.getDistance(x.getNumericAttrValues(), y.
