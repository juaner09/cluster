...
import com.timerchina.cluster.dbscan.DBSCANAlgorithm;
import com.timerchina.cluster.hierarchical.Dendrogram;
import com.timerchina.cluster.rock.ROCKAlgorithm;
import com.timerchina.digg.DiggStoryItem;
import com.timerchina.model.Attribute;
import com.timerchina.model.Content;
import com.timerchina.model.DataPoint;
import com.timerchina.similarity.ch4.CosineDistance;
import com.timerchina.utils.Attributes;
...
public class MyDiggSpaceData {
    ...
    private static void testDBSCAN() {
        ...
        DBSCANAlgorithm dbscan = new DBSCANAlgorithm(ds.getData(),  new CosineDistance(), eps, minPts, useTermFreq);
